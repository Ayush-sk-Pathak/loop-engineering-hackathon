...
export function fixtureEvidence(vendor: VendorCandidate): EvidenceSignal[] {
  if (vendor.id === "vendor-lookalike" || vendor.id === "vendor-pacificdye") {
    return [
      ...
      { kind: "payee_identity_match", value: false, outcome: "fail", detail: "Quoted payee name differs from the candidate legal entity", source: source("fixture-payee") },
  ...
  return [
    ...
    { kind: "payee_identity_match", value: true, outcome: "pass", detail: "Quoted payee and candidate legal entity agree", source: source("fixture-payee") },
